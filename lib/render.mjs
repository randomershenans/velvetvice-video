...
export async function renderClip({
  ...
  await renderMedia({
    ...
    serveUrl,
    codec: 'h264',
    // CRF 23 is the social-video sweet spot — visually indistinguishable from
    // Remotion's default 18 but roughly half the file size. Ayrshare's media
    // upload rejects with 413 above ~32MB, and a 60s 1080p vertical at CRF 18
    // sails past that.
    crf: 23,
